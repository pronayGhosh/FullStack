      ...
      this.appService.updateProjects(submitProject).subscribe(
        (data: any) => {
          ...
          if(data){
            ...
            if(data){
              this.modalHeading = 'Done';
              this.modalBody = 'Project has been added Successfully';
              document.getElementById("submitModalOpener").click();
            }else{
              this.modalHeading = 'Error';
              this.modalBody = 'Unexpected error occured during Add Task.';
              document.getElementById("submitModalOpener").click(); 
            }
          }else{
            this.modalHeading = 'Error';
      ...
      this.appService.updateProjects(submitProject).subscribe(
        (data: any) => {
          ...
          if(data){
            ...
            if(data){
              this.modalHeading = 'Done';
              this.modalBody = 'Project has been updated Successfully';
              document.getElementById("submitModalOpener").click();
            }else{
              this.modalHeading = 'Error';
              this.modalBody = 'Unexpected error occured during Add Task.';
  ...
  endProject(project: any){
    ...
    this.appService.updateProjects(project).subscribe(
      (data: any) => {
        ...
        if(data){
          this.modalHeading = 'Done';
          this.modalBody = 'Project has been suspended Successfully';
          document.getElementById("submitModalOpener").click();
        }else{
          this.modalHeading = 'Error';
          this.modalBody = 'Unexpected error occured during End Task.';
          document.getElementById("submitModalOpener").click(); 
        }
        this.appService.getProjects().subscribe((data :any) => {
          this.allProjectMasterList = data;
